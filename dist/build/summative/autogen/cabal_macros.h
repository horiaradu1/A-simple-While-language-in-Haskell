...
/* package summative-0.1.0.0 */
#ifndef VERSION_summative
#define VERSION_summative "0.1.0.0"
#endif /* VERSION_summative */
#ifndef MIN_VERSION_summative
#define MIN_VERSION_summative(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_summative */
...
/* package hxt-regex-xmlschema-9.2.0.3 */
#ifndef VERSION_hxt_regex_xmlschema
#define VERSION_hxt_regex_xmlschema "9.2.0.3"
...
#define CURRENT_COMPONENT_ID "summative-0.1.0.0-3dhI9IiZ9okGrsg5afy4K7-summative"
